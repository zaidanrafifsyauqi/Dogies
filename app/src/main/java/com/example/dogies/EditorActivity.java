...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch (requestCode) {
            case 1:
                ...
                break; // tambahkan break untuk mengakhiri switch
        }
    }
    ...
    private boolean saveContact() {
        // Inisialisasi hasAllRequiredValues dengan nilai false
        ...
        // Periksa apakah ada nilai yang diperlukan yang kosong
        if (TextUtils.isEmpty(name)) {
            ...
            // Semua nilai yang diperlukan ada, lanjutkan dengan menyimpan data
            ...
            // Set hasAllRequiredValues menjadi true jika data telah berhasil disimpan
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            // Check if the picture URI is not null before parsing the URI
            if (picture != -1) {
                ...
                if (contactpicture != null) {
                    ...
                    // If the picture URI is null, you may set a default image here
                    // Example: mPhoto.setImageResource(R.drawable.default_image);
                }
            }
